...
const Rentals = () => {
  ...
  useEffect(() => {
    async function fetchRentalsList() {
      ...
      query.equalTo("markettype", searchFilters.cartype);
    ...
    <>
      <div className="topBanner">
        ...
        <div className="searchReminder">
          ...
          <div className="vl" />
          <div className="filter">{searchFilters.markettype} Market Type</div>
      ...
      <div className="rentals-tabs">
        <div className="rentals-selected">Open Markets</div>
        <div>Close Markets</div>
        <div>Coop Markets</div>
        <div>Messages</div>
        <div>Settings</div>
      </div>
      <hr className="line" />
